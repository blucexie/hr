...
$(function () {
    ...
    /*$.ajax({
        ...
        success: function (data) {
            ...
            enterpriseName = jsonData.item.enterpriseName;
            resumeName = jsonData.item.verifyName;
            resumeIdCard = jsonData.item.verifyIdCard;
                        ...
                        if(result===1001){
                            ...
                            for(var i = 0;i<workJson.length;i++){
                                ...
                                var eT = workJson[i].workEndTime.split(""),
                                    arrEt = eT.splice(4,0,'-'),
                                    workEndTime = eT.join('');
                                $(".work:eq("+i+") input[name='workBalance']").val(workJson[i].workBalance);
