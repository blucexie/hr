...
$(function () {
  ...
  //  var showBankDom = document.querySelector('.edu');
    ...
    $('.addEducation').click(function () {
        $('.educate').css('display','block');
           ...
           // x++;
            ...
            '<p class="educateS"><span>教育信息'+eIndex+'</span><!--<button type="button" class="deleteBtn">删除此条记录</button>--></p>'+
    ...
    eduFn1(document.querySelector('.leaveCause'));
    ...
    $('.addWork').click(function () {
        ...
        if(jIndex>3){
           ...
           // xx++;
            ...
            '<p class="workTitleS"><span>工作经历'+jIndex+'</span><!--<button type="button" class="deleteBtnW">删除此条记录</button>--></p>'+
            '<div><span>公司名称</span><textarea class="firm" name="workEnterpriseName"  cols="30" rows="2"  data-attribute="请填写公司名称" placeholder="请正确填写公司名称，请勿填写简称" maxlength="40"></textarea></div>' +
        ...
        $('.educationTable').each(function () {
           ...
           /* educationItem['educationStartTime'] = educationItem['educationStartTime'].slice(0,4);
            ...
            if (educationItem['educationStartTime'] >= educationItem['educationEndTime']){
                ...
                $(this).find('input.EndTime').addClass('errorShow');
                basicPass = false;
                return false;
            }*/
