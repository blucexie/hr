...
$(function () {
    ...
    if(typeof(resumeStr)!="undefined"){
        ...
        for(var i = 0;i<eduLength-1;i++){
            ...
            '<div><span class="edu">学&emsp;&emsp;历</span><input onfocus="this.blur();" class='+(eduClass+(i+2))+'  type="text" name="educationGrade" data-attribute="请选择学历" placeholder="请输入学历"></div>'+
            '<div><span class="specialty">专&emsp;&emsp;业</span><input class="specialty"  type="text" name="educationMajor" data-attribute="请填写专业" placeholder="请输入专业名称" maxlength="18" onchange="value=value.replace(/[^\\a-\\z\\A-\\Z\\u4E00-\\u9FA5]/g,\'\')" onpaste="value=value.replace(/[^\\a-\\z\\A-\\Z\\u4E00-\\u9FA5]/g,\'\')"></div>' +
        ...
        if(resumeArray.isNewGraduate !=="1"){
            ...
            for(var i = 0;i<workLength-1;i++){
                ...
                '<div><i class="orangeBg"></i><span class="relation">关&emsp;&emsp;系</span><input onfocus="this.blur();" class='+(colleagueRelationship+(i+2))+'  type="text" name="colleagueRelationship"  data-attribute="请选择关系" placeholder="请选择关系"  maxlength="8"></div></form>');
   ...
   // var eIndex = 1;
    ...
    $('.addEducation').click(function () {
        ...
        if(eduLength==3){
            ...
            '<div><i class="greenBg"></i><span class="career">专&emsp;&emsp;业</span><input  class="specialty"   type="text" name="educationMajor" data-attribute="请填写专业" placeholder="请输入专业名称"  maxlength="18" onchange="value=value.replace(/[^\\a-\\z\\A-\\Z\\u4E00-\\u9FA5]/g,\'\')" onpaste="value=value.replace(/[^\\a-\\z\\A-\\Z\\u4E00-\\u9FA5]/g,\'\')"></div>' +
    ...
    $('.upEducation p').click(function () {
        ...
        if(onOffE){
            ...
            for(var i = 0;i<schoolArr.length;i++){
                $epE+='<p class="educate clearfix" style="display: block;"><span>教育信息</span></p>'+
                '<p class="clearfix"><i class="blueBg"></i><span class="ed">学校名称</span><span class="schName">'+schoolArr[i]+'</span></p>';
            }
    ...
    $('.upSkill p').click(function () {
        ...
        if(onOffS){
            ...
            for(var j = 0;j<certificateArr.length;j++){
                $skP+='<p class="clearfix"><i class="purpleBg"></i><span class="sk">技能信息</span><span class="skName">'+certificateArr[j]+'</span></p>'
            }
    ...
    $('.addWork').click(function () {
        ...
        if(workLength==3){
            ...
            '<div> <i class="blueBg"></i><span class="certifierTel">证明人电话</span><input class="referenceTel"  type="text" name="colleagueMobile" placeholder="请输入证明人电话" maxlength="11"></div>'+
            '<div><i class="orangeBg"></i><span class="relation">关&emsp;&emsp;系</span><input onfocus="this.blur();" class='+colleagueRelationship+'  type="text" name="colleagueRelationship"  data-attribute="请选择关系" placeholder="请选择关系"  maxlength="8"></div></form>');
    ...
    $('.upWorkExperience p').click(function () {
        ...
        if(onOffW){
            ...
            for(var j = 0;j<firmArr.length;j++){
                $wkP+='<p class="workTitleS clearfix"><span>工作经历</span></p>'+
                '<p class="clearfix"><i class="darkGreenBg"></i><span class="wk">工作经历</span><span class="wkName">'+firmArr[j]+'</span></p>'
            }
